    ...
    <div className='flex w-11/12 max-w-[1160px] justify-between py-12 mx-auto gap-x-12 gap-y-0'>
        ...
        <div className=' w-full max-w-[450px]'>
            ...
            <div className='flex items-center w-full gap-x-2 mt-4 '>
                ...
                <p className='text-richblack-700 leading-[0.375rem] font-medium'>OR</p>
                <div className='w-full h-[1px] bg-richblack-700'></div>
            </div>

            <button className='flex w-full justify-center items-center rounded-[8px] font-medium text-richblack-100 border border-richblack-700 py-[8px] gap-x-2 mt-6'>
               <FcGoogle/>
